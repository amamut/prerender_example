...
//   , url = require("url")
//   , zlib = require("zlib");
// let prerender = module.exports = function(req, res, next) {
...
//   })) { return false; }
//   console.log(isRequestingPrerenderedPage);
...
//     headers: {},
//   };
//   for (let attrname in this.prerenderServerRequestOptions) { options[attrname] = this.prerenderServerRequestOptions[attrname]; }
...
//   }
//   let fullUrl = protocol + "://" + (this.host || req.headers["x-forwarded-host"] || req.headers["host"]) + req.url;
